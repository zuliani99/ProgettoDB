...
from aeroporto.forms import RegistrationForm, LoginForm, UpdateAccountForm, RequestResetForm, ResetPasswordForm, AddBookingGone, AddBookingReturn, PlaneForm,  AddFlyForm, AirportForm, AddReviw, UpdateFlyForm, SearchFlyForm
