...
from aeroporto.forms import RegistrationForm, LoginForm, UpdateAccountForm, RequestResetForm, ResetPasswordForm, AddBooking, PlaneForm,  FlightForm, AirportForm, AddReviw
...
def configVolo(volo_id): 
	...
	#Set the informations of the flight in each field 
